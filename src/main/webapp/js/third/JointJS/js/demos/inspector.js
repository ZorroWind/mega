...
var CommonInspectorGroups = {
    text: { label: '文字属性', index: 2 },
    presentation: { label: '图形属性', index: 3 },
//    geometry: { label: 'Geometry', index: 3 },
//    data: { label: 'Data', index: 3 }
    object:{label:'对象属性',index:1}
};
...
var InputDefs = {
    ...
    'font-size': { type: 'range', min: 5, max: 80, unit: 'px', label: '字体大小' },
    ...
    'font-weight': { type: 'range', min: 100, max: 900, step: 100, defaultValue: 400, label: '字体粗细' },
    'fill': { type: 'color', label: '颜色' },
    'stroke': { type: 'color', defaultValue: '#000000', label: '边框颜色' },
    'stroke-width': { type: 'range', min: 0, max: 5, step: .5, defaultValue: 0, unit: 'px', label: '边框粗细' },
    'ref-x': { type: 'range', min: 0, max: .9, step: .1, defaultValue: .5, label: '水平位置' },
    'ref-y': { type: 'range', min: 0, max: .9, step: .1, defaultValue: .5, label: '竖直位置' },
    ...
    rx: { type: 'range', min: 0, max: 30, defaultValue: 1, unit: 'px', label: 'X轴半径' },
    ry: { type: 'range', min: 0, max: 30, defaultValue: 1, unit: 'px', label: 'Y轴半径' },
...
//                }
            	path: inp({
	            	prev: { type: 'text',group: 'object',label: 'prev', index: 1 },
	        	    next: { type: 'text',group: 'object', label: 'next', index: 2}
            	})
            },
...
//            'marker-target': { label: 'Target marker', index: 4 }
    ...
    'basic.Rect': {
        ...
        inputs: _.extend({
            attrs: {
                text: inp({
                    text: { group: 'object',type:'text', index: 2 ,label:'测站名称'},
                    'font-size': { group: 'text', index: 3 },
//                    'font-family': { group: 'text', index: 4 },
                    'font-weight': { group: 'text', index: 5 },
                    fill: { group: 'text', index: 6 },
                    stroke: { group: 'text', index: 7 },
                    'stroke-width': { group: 'text', index: 8 },
                    'ref-x': { group: 'text', index: 9 },
                    'ref-y': { group: 'text', index: 10 },
                    stcd: {type:'text',group: 'object',label: '测站编号', index: 11},
                    select : {type:'select',group: 'object',label: '测站选择', index: 1}
                }),
                rect: inp({
