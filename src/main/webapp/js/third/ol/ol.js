...
//已改
    ...
    }, dp = {"http://www.opengis.net/gml": {pointMember: N(Zo.prototype.$o)}}, ep = {
        "http://www.opengis.net/gml": {
    ...
    var tp = {rte: np, trk: pp, wpt: rp}, up = O(ip, {
            rte: Il(np),
            trk: Il(pp),
            wpt: Il(rp)
    ...
    var Bp = ["text", "type"], Ap = O(ip, {
        ...
        Dp = O(ip, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")), Ep = O(ip, {
            ele: N(Wo),
            time: N(function (a, c) {
    ...
    y(wq, Io);
    var yq = ["http://www.google.com/kml/ext/2.2"], zq = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2"], Aq = [255, 255, 255, 1], Bq = new ck({color: Aq}), Cq = [20, 2], Dq = [64, 64], Eq = new xi({
        anchor: Cq,
    ...
    }), xq = [new lk({fill: Bq, image: Eq, text: Gq, stroke: Fq, zIndex: 0})], Hq = {
        fraction: "fraction",
        pixels: "pixels"
    };
    ...
    var gr = O(zq, {value: Jl(U)}), fr = O(zq, {
        ...
        extrude: L(No),
        altitudeMode: L(U)
    }), Qq = O(zq, {coordinates: Jl(Mq)}), br = O(zq, {
    ...
    })), Vq = O(zq, {coordinates: Jl(Mq)}), kr = O(zq, {href: L(Nq)}, O(yq, {
        x: L(Qo),
        y: L(Qo),
        w: L(Qo),
        h: L(Qo)
    ...
    var Pr = O(zq, ["Document", "Placemark"]), Sr = O(zq, {
        ...
        }, Ur = O(zq, ["href"], O(yq, ["x", "y", "w", "h"])), Vr = O(zq, {href: N(Vo)}, O(yq, {
            x: N(Wo),
            y: N(Wo),
            w: N(Wo),
            h: N(Wo)
            ...
            color: N(zr),
            width: N(Wo)
        }), Br = O(zq, {LinearRing: N(Hr)}), cs = O(zq, {LineString: N(Hr), Point: N(Hr), Polygon: N(Kr)}), Er = O(zq,
    ...
    }), Wt = O(Jt, {Get: L(Ct), Post: L(Ct)}), Ut = O(Jt, {
        Name: L(U),
        Title: L(U),
        Abstract: L(U),
        LegendURL: Kl(Gt),
    ...
    var au = [null, "http://www.opengis.net/wmts/1.0"], bu = [null, "http://www.opengis.net/ows/1.1"], Zt = O(au, {
        ...
        hu = O(au, {Default: L(U), Value: Kl(U)}, O(bu, {Identifier: L(U)})), iu = O(bu, {
            LowerCorner: Il($t),
            UpperCorner: Il($t)
        }), eu = O(au, {
